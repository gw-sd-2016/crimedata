...
class Incident(gis_models.Model):
    ...
    lat = gis_models.DecimalField(null=True, blank=True, max_digits=10, decimal_places=6)
    lon = gis_models.DecimalField(null=True, blank=True, max_digits=10, decimal_places=6)
